 ...
 */
$config['site_title']           = "studyratings.com"; 		// Site Title, example.com
$config['admin_email']          = "admin@studyratings.com"; 	// Admin Email, admin@example.com
...
$config['user_ion_auth_domain']='@campagne-cmd.com';

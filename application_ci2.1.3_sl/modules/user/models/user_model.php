...
//        $this->lang->load('region');
        ...
        $this->tables  = array('user'=>'users');

        //initialize data
        $this->identity_column = 'user_id';
        $this->join='user_id';
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function users($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
...
//        echo $this->db->last_query();
    ...
    public function update($user_name,$password,$email,$first_name,$last_name,$bachelor_degree,$university_bachelor,$master_degree,$university_master,$user_id)
    {
        $this->response = $this->db->query("update users set 
                username = '".$user_name."'
                ,password = '".$password."'
                ,first_name = '".$first_name."'
                ,last_name = '".$last_name."'
                ,bachelor_degree = '".$bachelor_degree."'
                ,university_bachelor = '".$university_bachelor."'
                ,master_degree = '".$master_degree."'
                ,university_master = '".$university_master."'
                where id = '".$user_id."'");
        return $this;
    }
}

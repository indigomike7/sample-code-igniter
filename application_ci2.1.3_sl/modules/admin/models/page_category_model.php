...
class Page_category_model extends CI_Model
{
    /**
...
//        $this->lang->load('region');
        ...
        $this->tables  = array('page_category'=>'page_categories');
    ...
    public function categories($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        ...
        else
        {
                ...
                $this->db->select(array(
                    $this->tables['page_category'].'.*',
                    $this->tables['page_category'].'.category_id as category_id',
                    $this->tables['page_category'].'.category_name as category_name'
                ));
        }
...
//                echo $this->_limit." x y". $this->_offset;
        ...
        $this->response = $this->db->get($this->tables['page_category']);
...
//        echo $this->db->last_query();
    ...
    public function count_categories()
    {
        ...
        $this->trigger_events('count_categories');
        $this->db->select(array(
            'count(*) as count'
            ));
    ...
    {
        $this->response = $this->db->query("delete from page_categories where category_id = '".$id."'");
//        echo $this->db->last_query();
        return $this;
    }
    public function insert($category_name)
    {
        $this->response = $this->db->query("insert into page_categories(category_name) values( '".$category_name."')");
        return $this;
    }
    public function update($category_name, $category_id)
    {
        $this->response = $this->db->query("update page_categories set category_name = '".$category_name."' where category_id = '".$category_id."'");
        return $this;
    }
}
?>

...
//        $this->lang->load('region');
        ...
        $this->tables  = array('page'=>'page','page_category'=>'page_categories');

        //initialize data
        $this->identity_column = 'page_id';
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function pages($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
...
//           die ($this->_limit." x y". $this->_offset);
        ...
        $this->db->join('page_categories', 'page.category_id = page_categories.category_id','left');
        $this->response = $this->db->get($this->tables['page']);
//        echo $this->db->last_query();
    ...
    public function count_pages()
    {
        ...
        $this->trigger_events('count_pages');
        $this->db->select(array(
            'count(1) as count'
            ));
...
//        die($this->db->last_query());
    ...
    {
        $this->response = $this->db->query("delete from page where page_id = '".$id."'");
        return $this;
    }
    public function insert($page_title,$page_seo_title,$page_meta_description,$page_meta_keyword, $page_description, $category_id)
    {
    ...
    public function update($page_title,$page_seo_title,$page_meta_description,$page_meta_keyword, $page_description, $category_id, $page_id)
    {
        $this->response = $this->db->query("
            update page set 

...
class Program_category_model extends CI_Model
{
    /**
...
//        $this->lang->load('region');
        ...
        $this->tables  = array('program_category'=>'programs_categories');
    ...
    public function categories($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        ...
        else
        {
                ...
                $this->db->select(array(
                    $this->tables['program_category'].'.*',
                    $this->tables['program_category'].'.category_id as category_id',
                    $this->tables['program_category'].'.category_name as category_name'
                ));
        }
...
//                echo $this->_limit." x y". $this->_offset;
        ...
        $this->response = $this->db->get($this->tables['program_category']);
...
//        echo $this->db->last_query();
    ...
    {
        $this->response = $this->db->query("delete from programs_categories where category_id = '".$id."'");
//        echo $this->db->last_query();
        return $this;
    }
    public function insert($category_name)
    {
        $this->response = $this->db->query("insert into programs_categories(category_name) values( '".$category_name."')");
        return $this;
    }
    public function update($category_name, $category_id)
    {
        $this->response = $this->db->query("update programs_categories set category_name = '".$category_name."' where category_id = '".$category_id."'");
        return $this;
    }
}
?>

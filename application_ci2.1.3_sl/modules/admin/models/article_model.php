...
//        $this->lang->load('region');
        ...
        $this->tables  = array('article'=>'article','article_category'=>'article_categories');

        //initialize data
        $this->identity_column = 'article_id';
        $this->join='category_id';
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function articles($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
...
//           die ($this->_limit." x y". $this->_offset);
        ...
        $this->db->join('article_categories', 'article.category_id = article_categories.category_id','left');
        $this->response = $this->db->get($this->tables['article']);
//        echo $this->db->last_query();
    ...
    public function count_articles()
    {
        ...
        $this->trigger_events('count_articles');
        $this->db->select(array(
            'count(1) as count'
            ));
...
//        die($this->db->last_query());
    ...
    {
        $this->response = $this->db->query("delete from article where article_id = '".$id."'");
        return $this;
    }
    public function insert($article_title,$article_seo_title,$article_meta_description,$article_meta_keyword, $article_description, $category_id)
    {
    ...
    public function update($article_title,$article_seo_title,$article_meta_description,$article_meta_keyword, $article_description, $category_id, $article_id)
    {
        $this->response = $this->db->query("
            update article set 
                article_title = '".$article_title."'
                ,article_seo_title = '".$article_seo_title."'
                ,article_meta_description = '".$article_meta_description."'
                ,article_meta_keyword = '".$article_meta_keyword."'

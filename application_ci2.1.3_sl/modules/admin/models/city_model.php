...
//        $this->lang->load('region');
        ...
        $this->tables  = array('city'=>'cities','country'=>'countries');

        //initialize data
        $this->identity_column = 'city_id';
        $this->join='country_fips';
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function cities($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
...
//           die ($this->_limit." x y". $this->_offset);
        ...
        $this->db->join('countries', 'countries.country_fips = cities.country_fips','left');
...
//        echo $this->db->last_query();
    ...
    public function count_cities()
    {
        ...
        $this->trigger_events('count_cities');
        $this->db->select(array(
            'count(1) as count'
            ));
...
//        die($this->db->last_query());
    ...
    {
        $this->response = $this->db->query("delete from cities where city_id = '".$id."'");
        return $this;
    }
    public function insert($city_name,$country_fips)
    {
        $this->response = $this->db->query("insert into cities( 
            country_fips
            , city_name
            ) 
            values
    ...
    public function update($city_name,$country_fips,$city_id)
    {
        $this->response = $this->db->query("update cities set 

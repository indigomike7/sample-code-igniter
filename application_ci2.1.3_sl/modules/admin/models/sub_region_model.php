...
//        $this->lang->load('region');
        ...
        $this->tables  = array('region'=>'regions','sub_region'=>'sub_regions');

        //initialize data
        $this->identity_column = 'region_id';
        $this->join='region_id';
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function sub_regions($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
...
//        echo $this->_limit." x y". $this->_offset;
        ...
        $this->db->join('regions', 'sub_regions.region_id = regions.region_id','left');
        $this->response = $this->db->get($this->tables['sub_region']);
//        echo $this->db->last_query();

        return $this;
    }
    public function count_sub_regions()
    {
...
//        echo $this->db->last_query();
    ...
    {
        $this->response = $this->db->query("delete from sub_regions where sr_id = '".$id."'");
        return $this;
    }
    public function insert($sr_code,$sr_name,$region_id)
    {
        $this->response = $this->db->query("insert into sub_regions( sr_code, sr_name, region_id) values( '".$sr_code."','".$sr_name."','".$region_id."')");
        return $this;
    }
    public function update($sr_code,$sr_name,$region_id, $sr_id)
    {
        $this->response = $this->db->query("update sub_regions set sr_code = '".$sr_code."',sr_name = '".$sr_name."',region_id = '".$region_id."' where sr_id = '".$sr_id."'");
        return $this;
    }
}
?>

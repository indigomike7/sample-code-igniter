...
//        $this->lang->load('region');
        ...
        $this->tables  = array('site_setting'=>'site_settings');

        //initialize data
        $this->identity_column = 'setting_id';
        $this->join='setting_id';
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function settings($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
        ...
        $this->trigger_events('settings');

        $this->db->select(array(
            $this->tables['site_setting'].'.*'
        ));
...
//           die ($this->_limit." x y". $this->_offset);
        ...
        $this->response = $this->db->get($this->tables['site_setting']);

        return $this;
    }
    public function update($setting_name, $setting_desc)
    {

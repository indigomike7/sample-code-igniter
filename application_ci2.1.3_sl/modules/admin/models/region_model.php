...
//        $this->lang->load('region');
        ...
        $this->tables  = array('region'=>'regions');
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function regions($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
        ...
        else
        {
                ...
                $this->db->select(array(
                    $this->tables['region'].'.*',
                    $this->tables['region'].'.region_id as region_id',
                    $this->tables['region'].'.region_name as region_name'
                ));
        }
...
//                echo $this->_limit." x y". $this->_offset;
        ...
        $this->response = $this->db->get($this->tables['region']);
...
//        echo $this->db->last_query();
    ...
    {
        $this->response = $this->db->query("delete from regions where region_id = '".$id."'");
        return $this;
    }
    public function insert($region_name)
    {
        $this->response = $this->db->query("insert into regions(region_name) values( '".$region_name."')");
        return $this;
    }
    public function update($region_name, $region_id)
    {
        $this->response = $this->db->query("update regions set region_name = '".$region_name."' where region_id = '".$region_id."'");
        return $this;
    }
}
?>

...
class University_category_model extends CI_Model
{
    /**
...
//        $this->lang->load('region');
        ...
        $this->tables  = array('university_category'=>'universities_categories');

        //initialize data
        $this->identity_column = 'category_id';
    ...
    /**
        ...
        * @author Ben Edmunds
        **/
    public function categories($limit, $offset, $order_by,$order,$where,$like_index,$like_value)
    {
        $this->_limit = $limit;
        $this->_offset=$offset;
        ...
        else
        {
                ...
                $this->db->select(array(
                    ...
                    $this->tables['university_category'].'.category_id as category_id',
                    $this->tables['university_category'].'.category_name as category_name'
                ));
        }
...
//                echo $this->_limit." x y". $this->_offset;
        ...
        $this->response = $this->db->get($this->tables['university_category']);
...
//        echo $this->db->last_query();
    ...
    public function count_regions()
    {
        ...
        $this->trigger_events('count_regions');
        $this->db->select(array(
            'count(*) as count'
            ));
    ...
    {
        $this->response = $this->db->query("delete from universities_categories where category_id = '".$id."'");
//        echo $this->db->last_query();
        return $this;
    }
    public function insert($category_name)
    {
        $this->response = $this->db->query("insert into universities_categories(category_name) values( '".$category_name."')");
        return $this;
    }
    public function update($category_name, $category_id)
    {
        $this->response = $this->db->query("update universities_categories set category_name = '".$category_name."' where category_id = '".$category_id."'");
        return $this;
    }
}
?>

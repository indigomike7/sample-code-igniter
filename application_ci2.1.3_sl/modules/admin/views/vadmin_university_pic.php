...
?>
<form id="form1" action="<?php echo site_url("admin/university/upload/".(isset($university_id) ? $university_id : ''));?>" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="university_id" id="university_id" value="<?php echo (isset($university_id) ? $university_id : ''); ?>"/>
</form>
...
<script type="text/javascript">
            ...
            window.onload = function() {
                    var settings = {
                            ...
                            upload_url: "<?php echo site_url("admin/university/upload/".(isset($university_id) ? $university_id : ''));?>",
            ...
            {
                        var request = $.ajax({
                            url: '<?php echo site_url("admin/university/readdir/".$university_id);?>' ,
                            type: "POST",
                            data: "",
                            dataType: "json",
                            beforeSend:function()
            ...
            {
                        var request = $.ajax({
                            url: '<?php echo site_url("admin/university/delete_pic/".$university_id);?>' ,
                            type: "POST",

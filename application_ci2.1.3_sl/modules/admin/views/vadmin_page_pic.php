...
?>
<form id="form1" action="<?php echo site_url("admin/page/upload/".(isset($page_id) ? $page_id : ''));?>" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="page_id" id="page_id" value="<?php echo (isset($page_id) ? $page_id : ''); ?>"/>
</form>
...
<script type="text/javascript">
            ...
            window.onload = function() {
                    var settings = {
                            ...
                            upload_url: "<?php echo site_url("admin/page/upload/".(isset($page_id) ? $page_id : ''));?>",
            ...
            {
                        var request = $.ajax({
                            url: '<?php echo site_url("admin/page/readdir/".$page_id);?>' ,
                            type: "POST",
                            data: "",
                            dataType: "json",
                            beforeSend:function()
            ...
            {
                        var request = $.ajax({
                            url: '<?php echo site_url("admin/page/delete_pic/".$page_id);?>' ,
                            type: "POST",

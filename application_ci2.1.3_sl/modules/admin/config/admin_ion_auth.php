...
*/
$config['tables']['admin_users']           = 'admin_users';
$config['tables']['admin_groups']          = 'admin_groups';
$config['tables']['admin_users_groups']    = 'admin_users_groups';
$config['tables']['admin_login_attempts']  = 'admin_login_attempts';
